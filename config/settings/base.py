...
# define default value as fallback for test environment
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        # use simple JWT authentication system, not DRF default
...
SIMPLE_JWT = {
    ...
    # create a new refresh token when using the refresh token endpoint
